...
actor.list.auto = EnemyAuto(actor.extra):add{
  ...
  atk =    { isFrame(5) / hit(), isEnded / act("std") },
  atkup =  { isFrame(1) / hit(), isEnded / act("jmp"), isFloor / act("std") },
  jmpatk = { isFrame(3) / hit(), isEnded / act("jmp"), isFloor / act("std") },
  runatk = { isFrame(3) / hit(), isEnded / act("std") },
  atkalt = { isFrame(5) / hit(), isEnded / act("std") },
  atkrnd = { isFrame(1) / hit(), isEnded / act("std") },
  atksq1 = { isFrame(4) / hit(), isEnded / act("std") },
  atksq2 = { isFrame(3) / hit(), isEnded / act("std") },
  atksq3 = { isFrame(5) / hit(), isEnded / act("std") },
}
