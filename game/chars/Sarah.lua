...
actor.list.auto = EnemyAuto(actor.extra):add{
  atk = {  ActorScript.isFrame(5) / Beat.Script.hitAll(),
           ActorScript.isEnded / ActorScript.act("std") },
  run = {  ActorScript.move{x = 200} },
  atkup = { ActorScript.isFrame(1) / Beat.Script.hitAll(),
            ActorScript.isEnded / ActorScript.act("jmp"),
            ActorScript.isFloor / ActorScript.act("std") },
  jmpatk = {  ActorScript.isFrame(3) / Beat.Script.hitAll(),
              ActorScript.isEnded / ActorScript.act("jmp"),
              ActorScript.isFloor / ActorScript.act("std") },
  runend = {  ActorScript.isEnded / ActorScript.act("std") },
  runatk = {  ActorScript.isFrame(3) / Beat.Script.hitAll(),
              ActorScript.isEnded / ActorScript.act("std") },
  atkalt = {  ActorScript.isFrame(5) / Beat.Script.hitAll(),
              ActorScript.isEnded / ActorScript.act("std") },
  atkrnd = {  ActorScript.isFrame(1) / Beat.Script.hitAll(),
              ActorScript.isEnded / ActorScript.act("std") },
  atksq1 = {  ActorScript.isFrame(4) / Beat.Script.hitAll(),
              ActorScript.isEnded / ActorScript.act("std") },
  atksq2 = {  ActorScript.isFrame(3) / Beat.Script.hitAll(),
              ActorScript.isEnded / ActorScript.act("std") },
  atksq3 = {  ActorScript.isFrame(5) / Beat.Script.hitAll(),
              ActorScript.isEnded / ActorScript.act("std") },
}
