...
actor.rules = {
  ...
  atk3 = {  ActorScript.isFrame(4) / ActorScript.hitAll{dmg = 30, force = {x = 100, y = -180}},
            ActorScript.isEnde / ActorScript.act("std") },
  ...
  hitalt = {  -SceneScript.isFloor / ActorScript.act("hitair"),
               ActorScript.isEnded / ActorScript.act("std") },
  ...
  atkjmp1 = {  ActorScript.isFrame(1) / ActorScript.hitAll{dmg = 15},
               ActorScript.isEnded / ActorScript.act("jmp"),
               SceneScript.isFloor / ActorScript.act("std") },
...
actor.autorules = {
  std = {
     ActorScript.isTargetHit{"atk1"} ^ Script.random(6) / ActorScript.act("atk1"),
     ActorScript.isTargetHit{"atk2"} ^ Script.random(6) / ActorScript.act("atk2"),
     ActorScript.isTargetHit{"atk3"} ^ Script.random(6) / ActorScript.act("atk3"),
     ActorScript.isTargetHit{"atk4"} ^ Script.random(6) / ActorScript.act("atk4"),
     ActorScript.isTargetHit{"atk5"} ^ Script.random(6) / ActorScript.act("atk5"),
     ActorScript.isTargetHit{"atk6"} ^ Script.random(6) / ActorScript.act("atk6"),
     ActorScript.isTarget / ActorScript.act("wlk"),
  },
  
  wlk = { ActorScript.isTargetHit{"atk1", "atk2", "atk3", "atk4", "atk5", "atk6"} / ActorScript.act("std") },
}
