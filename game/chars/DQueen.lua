...
actor.states = {
  ...
  jmp = {res = "game/chars/morrigan/jmp.png", dim = {w =  72, h =  88}, frate = 0, nframes = 1, anim = Anim.Air3(60)},
  blk = {res = "game/chars/morrigan/blk.png", dim = {w = 178, h = 113}, frate = {[0] = 2, [1] = 8}, nframes = 2, anim = "play"},
  ...
  atk1 = {res = "game/chars/morrigan/atk1.png", dim = {w = 200, h =  89}, frate = 3, nframes = 5, anim = "play"},
  atk2 = {res = "game/chars/morrigan/atk2.png", dim = {w = 120, h =  99}, frate = 3, nframes = 3, anim = "play"},
  atk3 = {res = "game/chars/morrigan/atk3.png", dim = {w = 200, h = 114}, frate = 3, nframes = 6, anim = "play"},
  atk4 = {res = "game/chars/morrigan/atk4.png", dim = {w = 220, h = 105}, frate = 3, nframes = 4, anim = "play"},
  atk5 = {res = "game/chars/morrigan/atk5.png", dim = {w = 192, h = 126}, frate = 3, nframes = 6, anim = "play"},
  atk6 = {res = "game/chars/morrigan/atk6.png", dim = {w =  76, h = 140}, frate = {4, [3] = 0}, nframes = 3, anim = "play",
          pad = {x = 0.5, y = -25}},
...
actor.rules = {
  ...
  jmpbck = {  std = ActorScript.isEnded + SceneScript.isFloor },
...
actor.autorules = {
  std = {
    ...
    bck =   ActorScript.isRange("x", 20),
    wlk =  -ActorScript.isTargetHit{"atk1", "atk2", "atk3", "atk4", "atk5", "atk6"} ^
            ActorScript.isRange("x", 120, 20),
    jmp =   ActorScript.isTarget ^ ActorScript.isRange("x", 360, 120) / ActorScript.move{x = 100, y = -220},
    atk1 =  ActorScript.isTargetHit("atk1") ^ Script.random(24),
    atk2 =  ActorScript.isTargetHit("atk2") ^ Script.random(24),
    atk3 =  ActorScript.isTargetHit("atk3") ^ Script.random(24),
    atk4 =  ActorScript.isTargetHit("atk4") ^ Script.random(24),
    atk5 =  ActorScript.isTargetHit("atk5") ^ Script.random(24),
    atk6 =  ActorScript.isTargetHit("atk6") ^ Script.random(24),
--[[    jmpbck = (ActorScript.isTarget ^ ActorScript.isRange("x", 40)) / ActorScript.move{x = -120, y = -240},
    atk2 = ActorScript.isTarget ^ ActorScript.isHit("atk2"),
    atk3 = ActorScript.isTarget ^ ActorScript.isHit("atk3"),
    atk4 = ActorScript.isTarget ^ ActorScript.isHit("atk4"),
    atk5 = ActorScript.isTarget ^ ActorScript.isHit("atk5"),
    atk6 = ActorScript.isTarget ^ ActorScript.isHit("atk6") / ActorScript.move{x = 200, y = -240},
]]  },
  
  wlk = {
    bck =  ActorScript.isRange("x", 20),
    wlk = -ActorScript.isTargetHit{"atk1", "atk2", "atk3", "atk4", "atk5", "atk6"} ^ -ActorScript.isRange("x", 20),
    std =  ActorScript.isTargetHit{"atk1", "atk2", "atk3", "atk4", "atk5", "atk6"} ^ -ActorScript.isRange("x", 20) +
          -ActorScript.isTarget,
  },
  
  bck = {
    bck =  ActorScript.isRange("x", 80),
    std = -ActorScript.isRange("x", 80),
  },
  
  jmp = {
--    atkjmp1 = ActorScript.isTarget ^ ActorScript.isHit("atkjmp1"),
--    atkjmp2 = ActorScript.isTarget ^ ActorScript.isHit("atkjmp2"),
  },
}
