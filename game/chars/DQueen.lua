...
actor.list.auto = ActorDlg.new{
  ...
  bck = {  ActorScript.move{x = -100, z = 100} },
  jmp = {  SceneScript.isFloor / ActorScript.act("stdup") },
  ...
  jmpend = {  SceneScript.isFloor / ActorScript.act("stdup") },
  jmpbck = {  SceneScript.isFloor / ActorScript.act("stdup") },
  atkjmp1 = { ActorScript.isFrame(1) / ActorScript.hitAll{dmg = 15},
              ActorScript.isEnded / ActorScript.act("jmpend"),
              SceneScript.isFloor / ActorScript.act("stdup") },
...
actor.list.AI = ActorDlg.new{
  std = {
    ...
    ActorScript.isRange("x", 0) ^ Script.random(2) / ActorScript.act("jmpbck") / ActorScript.move{x = -200, y = -200},
